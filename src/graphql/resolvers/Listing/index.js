    ...
    Query: {
        ...
        listings: (_root, { location, filter, limit, page }, { db }) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                ...
                if (location) {
                    const { country, admin, city } = yield api_1.PositionStack.geocode(location);
                    if (city)
                        query.city = city;
                    if (admin)
                        query.admin = admin;
                ...
                throw new Error(`Faild to query Listings: ${err}`);
            }
        }),
    },
    Mutation: {
        hostListing: (_root, { input }, { db, req }) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const { country, admin, city } = yield api_1.PositionStack.geocode(input.address);
    ...
    Listing: {
        ...
        bookings: (listing, { limit, page }, { db }) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                ...
                throw new Error(`Failed to get Listing bookings. ${err}`);
            }
        }),
    },
};
